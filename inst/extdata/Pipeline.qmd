...
format_arrow_table <- function() {
  targets::tar_format(
    ...
    write = function(object, path) {
      arrow::write_parquet(object, path, version = "2.0")
    },
...
format_arrow_dataset <- function() {
  targets::tar_format(
    ...
    write = function(object, path) {
      arrow::write_dataset(object, path, version = "2.0")
    },
