---
title: "flat_genomics_functions.Rmd"
...
```{r example-metal_config, include=FALSE}
#' \dontrun{
...
```{r example-metal_run, include=FALSE}
#' \dontrun{
...
```{r example-plink_extract_ld, include=FALSE}
#' \dontrun{
...
```{r example-hyprcoloc_df, include=FALSE}
#' \dontrun{
...
```{r example-coloc_run, include=FALSE}
#' \dontrun{
coloc_run(locus_df)
#' }
```
...
```{r example-calc_credset, include=FALSE}
#' \dontrun{
...
```{r example-run_carma, include=FALSE}
#' \dontrun{
...
```{r example-magmar, include=FALSE}
#' \dontrun{
...
```{r example-s_predixcan, include=FALSE}
#' \dontrun{
...
```{r example-s_multixcan, include=FALSE}
#' \dontrun{
s_multixcan(df,
...
```{r example-ldak_h2, include=FALSE}
#' \dontrun{
...
```{r development-inflate, include=FALSE}
# Run but keep include=FALSE to avoid infinite loop
# Execute in the console directly

fusen::inflate(flat_file = "dev/flat_genomics_functions.Rmd", vignette_name = NA)
```
