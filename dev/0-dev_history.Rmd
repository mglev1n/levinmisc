...
# Inflate
```{r}
fusen::inflate(flat_file = "dev/flat_genomics_functions.Rmd", vignette_name = "Genomics Functions", check = FALSE, overwrite = TRUE, open_vignette = FALSE)
fusen::inflate(flat_file = "dev/flat_miscellaneous.Rmd", vignette_name = "Miscellaneous Functions", check = FALSE, overwrite = TRUE, open_vignette = FALSE)
